...
export const normalizePrice = function(value) {
...
export const getObjectProperty = function(object, property) {
  return (
    (object && object.hasOwnProperty(property) && object[property]) || null
  );
};
